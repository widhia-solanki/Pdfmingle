...
const GoogleIcon = () => (
  <svg className="h-5 w-5" viewBox="0 0 48 48" aria-hidden="true">
    ...
    <path
      fill="#1976D2"
      d="M43.611 20.083H42V20H24v8h11.303a11.96 11.96 0 0 1-4.087 5.574l6.19 5.238C39.902 36.638 44 30.65 44 24c0-1.341-.138-2.65-.389-3.917Z"
    />
  </svg>
);
          ...
          <div className="w-full max-w-sm space-y-6">
            {isSubmitted ? (
              ...
              <>
                ...
                <Button variant="outline" className="w-full h-11" onClick={() => toast({ title: 'Coming Soon!', description: 'Google Sign-in will be available shortly.' })}><span className="mr-2 inline-flex"><GoogleIcon /></span> Continue with Google</Button>
