  ...
  return (
    <>
      ...
      <div className="animate-in fade-in duration-500 bg-background">
        ...
        {/* Contact Info Section - Use semantic colors */}
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-4xl text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-8 md:gap-16">
              <a href="mailto:contact.dafda.pdfmingle@gmail.com" className="flex items-center gap-3 text-xl text-muted-foreground hover:text-primary transition-colors">
