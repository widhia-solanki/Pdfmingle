      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-base md:text-lg leading-relaxed text-muted-foreground">
            DAFDA Products is a forward-thinking technology company committed to creating 
            simple, powerful, and accessible digital solutions for people and businesses 
            worldwide. Our flagship product, <strong className="font-semibold text-brand-blue">PDF</strong>Mingle, 
            provides a seamless, efficient, and secure way to work with PDF files.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 max-w-5xl">
          <div className="text-center md:text-left">
            ...
            <p className="text-muted-foreground leading-relaxed">
              To become a trusted global leader in productivity tools by delivering 
              innovation, reliability, and a user-friendly experience for everyone.
            </p>
          </div>
          <div className="text-center md:text-left">
            <h3 className="text-2xl font-bold text-foreground mb-3">Our Mission</h3>
            <p className="text-muted-foreground leading-relaxed">
              We aim to create tools that remove complexity and put control back in 
              the hands of users. Every feature we build focuses on speed, simplicity, 
              and security — because your time and privacy matter.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-5xl text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="space-y-3">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Dr. Solanki takes care of the expenses and resources required 
                to keep the website running. He ensures that the platform remains 
                active, reliable, and accessible for users. His support helps 
                maintain smooth operations, regular updates, and continued 
                improvements for PDFMingle.
              </p>
            </div>
            ...
            <div className="space-y-3 flex flex-col items-center">
              ...
              <p className="text-muted-foreground leading-relaxed text-center">
                ...
                efficiently, believing that age doesn't limit the ability to 
