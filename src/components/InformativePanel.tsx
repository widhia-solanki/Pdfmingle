...
// --- THIS IS THE CORRECT DISCORD ICON ---
const DiscordIcon = () => (
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center space-x-2">
                           <a 
                             ...
                             className="flex items-center justify-center h-10 w-10 bg-gray-200 dark:bg-gray-700 rounded-full text-gray-600 dark:text-dark-text-secondary hover:bg-brand-blue hover:text-white dark:hover:bg-brand-blue transition-all"
                           >
                             <RedditIcon />
                           </a>
                           <a 
