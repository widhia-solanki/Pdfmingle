...
export const InformativePanel = () => {
    return (
        // THE FIX:
        // - `bg-secondary`: A subtle off-white/off-black background.
        // - `border-t border-border`: Uses the theme's border color.
        <section className="w-full py-16 md:py-24 border-t border-border bg-secondary">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-left">
                    <div className="space-y-3">
                        {/* Use `text-foreground` for primary headings */}
                        <h4 className="font-bold text-lg text-foreground">PDFMingle</h4>
                        <ul className="space-y-2">
                            {/* Use `text-muted-foreground` for links and `hover:text-primary` for hover */}
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center space-x-2">
                           <a 
                             ...
                             // Use theme variables for the icon buttons
                             className="flex items-center justify-center h-10 w-10 bg-muted rounded-full text-muted-foreground hover:bg-primary hover:text-primary-foreground transition-all"
                           >
                             <RedditIcon />
                           </a>
                           <a 
