...
import { Menu, X, FileQuestion, Info, LogIn, LogOut, Mail, User } from "lucide-react";
        ...
        <nav className="flex-grow overflow-y-auto p-4 space-y-2">
          ...
          <div className="flex flex-col gap-1 px-3 pt-2">
             {loading ? (
                ...
                <Button variant="outline" className="justify-start gap-3 p-3 h-auto text-muted-foreground" onClick={handleLogout}>
