...
export const ProfileCard = () => {
  ...
  const handleSaveProfile = async () => {
    setIsSaving(true);
    try {
      const response = await fetch('/api/account/profile', { // This should be your backend API
        method: 'PUT',
      ...
      // Crucially, update the NextAuth session on the client
  ...
  // Note: File upload to a custom backend requires a separate endpoint.
        ...
        <div className="space-y-2">
          ...
          {isEditing ? (
            <div className="flex items-center gap-2">
              ...
              <Button onClick={handleSaveProfile} size="icon" disabled={isSaving}>
