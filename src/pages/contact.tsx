      ...
      <div className="animate-in fade-in duration-500">
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-4xl text-center">
            <h2 className="text-3xl font-bold mb-4 text-ilovepdf-text">Contact Information</h2>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-8 md:gap-16">
              <a href="mailto:contect.bluelay@gmail.com" className="flex items-center gap-3 text-xl text-gray-700 hover:text-ilovepdf-red transition-colors">
                <Mail className="h-8 w-8" />
                <span>contect.bluelay@gmail.com</span>
              </a>
              <a href="https://www.pdfmingle.org" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-xl text-gray-700 hover:text-ilovepdf-red transition-colors">
